...
const Main = () => {
  ...
  const renderComponent = () => {
    switch (selectedComponent) {
      ...
      case "RestoreWallet":
        return <RestoreWallet setSelectedComponent={setSelectedComponent} />;
      default:
        return <Menu setSelectedComponent={setSelectedComponent} />;
    }
  };
  ...
  return (
    <div
      style={{ height: "750px" }}
      className="bg-white sm:grid sm:grid-cols-2 items-center shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] relative w-full max-w-[1400px] rounded-lg font-[sans-serif] overflow-hidden mx-auto mt-4 sm:grid-rows-1"
    >
      <div className="min-h-[580px] h-full hidden sm:block">
        <Image
          src={bgImage}
